...
2. **Error handling**: INVALID_CREDENTIALS falls back to mock data; other IntervalsApiError types return error responses; unexpected errors bubble up to catch-all
